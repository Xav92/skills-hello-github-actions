...
_Create a GitHub Action and use it in a workflow._ :bowtie:
...
1. Make a new branch named `test-workflow`. :+1:
1. Commit any change to your branch, such as adding an emoji to your README.md file. :fire:
1. Create the pull request on your branch.
1. See your action run on your pull request. 
1. Wait about 20 seconds for actions to run, then refresh this page (the one you're following instructions from) and an action will automatically close this step and open the next one. :clap:
